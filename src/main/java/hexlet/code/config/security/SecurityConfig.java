...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    public SecurityConfig(@Value("${base-url}") final String pBaseUrl,
                          final UserDetailsService pUserDetailsService,
                          final PasswordEncoder pPasswordEncoder,
                          final JWTHelper pJwtHelper) {
        this.loginRequest = new AntPathRequestMatcher(pBaseUrl + LOGIN, POST.toString());
        this.publicUrls = new OrRequestMatcher(
            loginRequest,
            new AntPathRequestMatcher(pBaseUrl + USER_CONTROLLER_PATH, POST.toString()),
            new AntPathRequestMatcher(pBaseUrl + USER_CONTROLLER_PATH, GET.toString()),
            new NegatedRequestMatcher(new AntPathRequestMatcher(pBaseUrl + "/**"))
        );
